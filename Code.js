...
function sendEmails(
  ...
  // let successCount = 0;
  // let errorCount = 0;
  let errorMessages = []; // To store error messages for dialog display
  ...
  obj.forEach(function (row, rowIdx) {
    if (row[EMAIL_SENT_COL] !== "") {
      try {
        ...
        Logger.log(e);
        errorCount++;
        errorMessages.push(`Row ${rowIdx + 1}: ${e.message}`);
  ...
  function getInfoByCampus(campusValue) {
    switch (campusValue.toLowerCase()) {
      // case 'bernal':
      //   return {
      //    recipients: ['david.laboy@nisd.net', 'jose.mendez@nisd.net', 'monica.flores@nisd.net', 'sally.maher@nisd.net'],
      //    driveLink: '1jyY1gPUgj2xLd7K5AWto6l3ictRP2xHQ'
      //   };
      // case 'briscoe':
      //   return {
      //     recipients: ['Joe.bishop@nisd.net', 'nereida.ollendieck@nisd.net', 'brigitte.rauschuber@nisd.net', 'veronica.martinez@nisd.net'],
      ...
      // case 'garcia':
      //   return {
      //     recipients: ['mark.lopez@nisd.net', 'lori.persyn@nisd.net', 'julie.minnis@nisd.net', 'mateo.macias@nisd.net', 'anna.lopez@nisd.net'],
      ...
      // case 'jefferson':
      //   return {
      //     recipients: ['Nicole.aguirreGomez@nisd.net', 'monica.cabico@nisd.net', 'maria-1.martinez@nisd.net', 'tiffany.watkins@nisd.net', 'catherine.villela@nisd.net'],
      ...
      // case 'jordan':
      //   return {
      //     recipients: ['anabel.romero@nisd.net', 'Shannon.Zavala@nisd.net', 'laurel.graham@nisd.net', 'jessica.marcha@nisd.net', 'robert.ruiz@nisd.net', 'ryanne.barecky@nisd.net', 'adrian.hysten@nisd.net', 'patti.vlieger@nisd.net'],
      //     driveLink: '1lOKHdlFWLqDMg4IAOglq1V6om_nHpjnD'
      //   };
      // case 'luna':
      //   return {
      //     recipients: ['leti.chapa@nisd.net', 'jennifer.cipollone@nisd.net', 'amanda.king@nisd.net', 'lisa.richard@nisd.net'],
      //     driveLink: '1JBEzGoN44aZlfgw2ZOnMewGqTya0y-dN'
      //   };
      // case 'neff':
      //   return {
      //     recipients: ['yvonne.correa@nisd.net', 'theresa.heim@nisd.net', 'joseph.castellanos@nisd.net', 'adriana.aguero@nisd.net', 'priscilla.vela@nisd.net', 'michele.adkins@nisd.net', 'laura-i.sanroman@nisd.net', 'jessica.montalvo@nisd.net'],
      //     driveLink: ''
      //   };
      // case 'pease':
      //   return {
      //     recipients: ['Lynda.Desutter@nisd.net', 'tamara.campbell-babin@nisd.net', 'tiffany.flores@nisd.net', 'tanya.alanis@nisd.net', 'brian.pfeiffer@nisd.net'],
      //     driveLink: '1MvxU28snFNspmlryjeV27CgNYWsqGn6S'
      //   };
      // case 'rawlinson':
      //   return {
      //     recipients: ['jesus.villela@nisd.net', 'david.rojas@nisd.net', 'nicole.buentello@nisd.net', 'elizabeth.smith@nisd.net'],
      //     driveLink: '1j71vRF2rN4p75T2SVN_2_DovpfKKPn3s'
      //   };
      // case 'rayburn':
      //   return {
      //     recipients: ['Robert.Alvarado@nisd.net', 'maricela.garza@nisd.net', 'aissa.zambrano@nisd.net', 'brandon.masters@nisd.net', 'micaela.welsh@nisd.net'],
      //     driveLink: '10sEkjJf2XZ38zBgrnRrfmj5UwVrE_N5h'
      //   };
      // case 'ross':
      //   return {
      //     recipients: ['mahntie.reeves@nisd.net', 'christina.lozano@nisd.net', 'claudia.salazar@nisd.net', 'jason.padron@nisd.net', 'katherine.vela@nisd.net', 'dolores.cardenas@nisd.net', 'roxanne.romo@nisd.net', 'rose.vincent@nisd.net'],
      ...
      // case 'stevenson':
      //   return {
      //     recipients: ['anthony.allen01@nisd.net', 'hilary.pilaczynski@nisd.net', 'johanna.davenport@nisd.net', 'amanda.cardenas@nisd.net', 'chaeleen.garcia@nisd.net'],
    ...
    return {
      message: {
        ...
        html: `Dear ${row["Campus"]},<br><br>
              ...
              JD<br><br>
              ${row["Merged Doc URL - Home Campus Transition Plan"]}<br>
              ${row["Merged Doc URL - Student Transition "]}<br>
